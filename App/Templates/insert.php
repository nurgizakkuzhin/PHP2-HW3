        ...
        <div>
            <form action="/admin/insert.php" method="post">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" id="formGroupExampleInput" placeholder="Введите заголовок">
                </div>
                <div class="form-group">
                    <label for="validationTextarea">Текст</label>
                    <textarea class="form-control" name="content" rows="10" id="validationTextarea" placeholder="Введите текст"></textarea>
                </div>
